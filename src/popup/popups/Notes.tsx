...
import { Updates, Notification } from '../interfaces';
...
const Notes = ({ setOpen, updates, notifications }: NotesProps) => {
  const [page, setPage] = useState<'notifications' | 'patchs'>('notifications');
